---
title: "Dados abertos e novós negocios: exemplos nacionas e de além-mar"
subtitle: "Palestra (Prefeitura de Recife, Emprel, AFD)"
...
params:
  event: Dados abertos e novós negocios, exemplos nacionas e de além-mar
  slug: recife/meetup
---
...
.center[.reduite[![](https://datactivist.coop/recife/workshop/img/image32.png)]]
...
Nous n'évaluons pas facilement tous les bénéfices de l'open data :
![](https://datactivist.coop/recife/workshop/./img/image46.png)

---
### Le potentiel économique de l'open data est énorme
...
### .red[3 to 5 trillion $]
Exemple : Monsanto acquired the Climate Corporation, a ompany that leverages open data to inform farmers for approximately **1.1 billion $**
...
.pull-left[
![](https://datactivist.coop/recife/workshop/./img/image9.png)
]
.pull-right[
...
.reduite[![](https://datactivist.coop/recife/workshop/img/image43.png)]
...
![](https://datactivist.coop/recife/workshop/img/image53.png)
...
.pull-right[
.reduite[![](https://datactivist.coop/recife/workshop/img/iceberg.png)]
]
---
...
![](https://datactivist.coop/recife/workshop/img/image47.png)
---
...
![](https://datactivist.coop/recife/workshop/./img/image50.png)			
---
...
### Para a .red[ciência dos dados e o conhecimento aberto]  
Exemplo da base de dados de acidentes rodoviários:
![](https://datactivist.coop/recife/workshop/img/image48.png)
...
.pull-right[
![](https://datactivist.coop/recife/workshop/img/image38.png)
]			
